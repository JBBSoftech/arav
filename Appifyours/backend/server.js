...
// MongoDB connection
mongoose.connect(process.env.MONGODB_URI || 'mongodb://localhost:27017/arav_app', {
...
app.get('/api/app-config', async (req, res) => {
  try {
    ...
    const config = {
      adminId: '690de5484f9e50be403089ef',
      shopName: 'Arav',
...
app.listen(PORT, () => {
  console.log(`Arav Backend Server running on port ${PORT}`);
});
