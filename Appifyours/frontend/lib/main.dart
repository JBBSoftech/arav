...
// Admin-specific configuration for user data linking
class AdminConfig {
  ...
  // Store user data linked to this admin
  ...
  // Store detailed order data with products, quantities, and prices
  ...
  // Register new user with complete profile (ensures data goes to userElementScreens)
  ...
  // Get dynamic configuration from admin
...
// Price utility class for dynamic price operations
class PriceUtils {
    ...
    return Column(
      children: [
            Container(
              ...
              child: Text('Appifyours', style: TextStyle(fontSize: 24, fontWeight: FontWeight.bold)),
            ),
                  Container(
